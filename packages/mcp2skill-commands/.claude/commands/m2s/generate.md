...
**Reference:** ./.claude/commands/m2s/docs/skill-authoring-guide.md for all best practices to follow.
...
**Now enhance it** following ./.claude/commands/m2s/docs/skill-authoring-guide.md:
...
Check the generated SKILL.md against ./.claude/commands/m2s/docs/skill-authoring-guide.md:
...
**Follow ./.claude/commands/m2s/docs/skill-authoring-guide.md throughout:**
